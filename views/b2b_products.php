...
$config = require_once __DIR__ . '/../config/b2b_woocommerce.php';
...
try {
    ...
    echo "<p style='color: red;'>B2B Ürünleri Yüklenemedi: " . htmlspecialchars($e->getMessage()) . "</p>";
}
?>
